...
public class LogConfig {
	...
	@Around("within(com.hansung.web.controller.AuthController))")
	public Object userLogging(ProceedingJoinPoint pjp) throws Throwable {
		...
		try {
			...
			log.warn("USER_WARN: [action: : ({}), error_message : ({})]", e.getAction(), e.getMessage());
		} catch (Exception e) {
	...
	@Around("execution(* com.hansung.web.controller..*.get*(..))")
	...
	@Around("execution(* com.hansung.web.controller..*.insert*(..)) || "
